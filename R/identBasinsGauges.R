...
#' 1. "res" is the treated reservoir,
#' 2. "catch" is the catchment contributing to this reservoir,
#' 3. "catch_km2" gives the area of the catchment in square kilometers,
#' 4. "catch_buffer" is a shapefile of a buffer zone of the chosen size around the catchment,
#' 5. "gauges_catch" is a point shapefile with the rain gauges within "catch_buffer" and
#' 6. "routing" is logical, indicating if routing can be done (TRUE when the reservoir receives water from upstream subbasins)
#' @export
